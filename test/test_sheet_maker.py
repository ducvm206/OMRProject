...
class AnswerSheetDesigner:
    def __init__(self, lato_font_path=None):
        ...
        self.design_config = {
            'page_size': 'Letter',
            'margins': {'top': 10, 'bottom': 30, 'left': 30, 'right': 30},
            'bubble_radius': 7,
        ...
        # Predefined presets
        self.presets = {
            10: {'columns': 2, 'questions_per_page': 10, 'row_spacing': 40},
            20: {'columns': 2, 'questions_per_page': 20, 'row_spacing': 35},
            30: {'columns': 3, 'questions_per_page': 30, 'row_spacing': 30},
            40: {'columns': 4, 'questions_per_page': 40, 'row_spacing': 30}
        }
    ...
    def _draw_pdf_student_id(self, c, page_width, page_height):
        ...
        start_x = page_width - margins['right'] - id_section_width - 50
        start_y = margins['bottom'] + id_section_height - 20
        
        # Draw title
        c.setFont(font_bold, 10)
        c.drawString(start_x + 10, start_y + 35, "STUDENT ID")
        ...
        box_x2 = start_x + id_section_width - 5
        box_y2 = start_y + 20
    ...
    def _draw_pdf_questions(self, c, page_width, page_height, current_page, total_questions):
        """Draw questions and bubbles on PDF with Lato font"""
        margins = self.design_config['margins']
        questions_per_page = self.design_config['questions_per_page']
        ...
        for col in range(columns):
            ...
            for row in range(questions_per_column):
                ...
                if self.design_config['show_question_numbers']:
                    ...
                    c.drawString(col_x, row_y, f"{question_num}.")
